...
def is_word_guessed(secret_word, letters_guessed):
    ...
    if letter_count == len(secret_word): # if the number of correctly guessed
        ...
        return True
wordtest = 'gorilla'
is_word_guessed(wordtest, ['g', 'o', 'r', 'i', 'l', 'a']) # True
is_word_guessed(wordtest, ['g', 'x', 'b', 'i', 'l', 'a']) # False
is_word_guessed(wordtest, ['g', 'o', 'r', 'i', 'l']) # False
...
wordtest = 'gorilla'
get_guessed_word(wordtest, ['g', 'o', 'r', 'i', 'l', 'a']) # 'gorilla'
get_guessed_word(wordtest, ['g', 'x', 'b', 'i', 'l', 'a']) # 'g_ _ illa'
get_guessed_word(wordtest, ['g', 'a', 'r', 'i', 'b']) # 'g_ ri_ _ a'
...
def show_possible_matches(my_word):
    ...
    # after trying multiple times to get it working
    ...
    for other_word in wordlist: # essentially for every word in wordlist
        if match_with_gaps(my_word, other_word): # run match_with_gaps with
            # every single word being the other_word
...
hangman(secret_word)
# slight issue - when you run the file as a whole, the outcome of hangman
# (win or loss) does not show on console
